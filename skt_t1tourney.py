...
from skt_t1std import SKT_T1Std
from collections import defaultdict
from random import sample 

class SKT_T1Tourney(SKT_T1Std):
    def post_init(self):
...
to any given peer. 
        ...
        # optimistically unchoke the peer with rarest or the most number of pieces we need
        ...
        # Optimistic unchoking every 3 rounds: choose agent with most needed pieces who isn't already in peers_to_unchoke
